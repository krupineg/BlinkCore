...
var destinationIp = Argument("destinationPi", "192.168.31.213");
var destinationDirectory = Argument("destinationDirectory", @"/home/pi/apps/BlinkCore");
var username = Argument("username", "pi");
var sessionname = Argument("sessionname", "pi_session");
var executableName = Argument("executableName", "BlinkCore");
